...
module EXU(
  ...
  wire [31:0]       alu_b = io_in_alu_src ? io_in_imm : io_in_rs2_data;
  wire [62:0]       _alu_result_T_8 = {31'h0, io_in_rs1_data} << alu_b[4:0];
  wire [15:0][31:0] _GEN =
    {{32'h0},
     {32'h0},
     {32'h0},
     ...
     {32'h0},
     {32'h0},
     {{31'h0, io_in_rs1_data < alu_b}},
     {{31'h0, $signed(io_in_rs1_data) < $signed(alu_b)}},
     {$signed($signed(io_in_rs1_data) >>> alu_b[4:0])},
     {io_in_rs1_data >> alu_b[4:0]},
  ...
  wire [7:0]        _GEN_1 =
    {{_GEN_0},
     {io_in_rs1_data < io_in_rs2_data},
     {$signed(io_in_rs1_data) >= $signed(io_in_rs2_data)},
     {$signed(io_in_rs1_data) < $signed(io_in_rs2_data)},
     {_GEN_0},
     {_GEN_0},
     {io_in_rs1_data != io_in_rs2_data},
