...
### scala.reflect.internal.FatalError: no context found for source-file://<WORKSPACE>/src/main/scala/MiniRV.scala,line-9,offset=302
...
// stall: 发生lo@@ad-use冒险时启用. pc[输出接输入打一拍], if_id_reg[输出接输入打一拍], id_ex_reg[插入气泡.]. 后续寄存器不影响.
