...
### scala.reflect.internal.FatalError: no context found for source-file://<WORKSPACE>/src/main/scala/MiniRV.scala,line-3,offset=77
...
// 所以, 判断哪个module是顶层模块, 就看哪个cl@@ass有伴生object, 其内部生成verilog代码.
