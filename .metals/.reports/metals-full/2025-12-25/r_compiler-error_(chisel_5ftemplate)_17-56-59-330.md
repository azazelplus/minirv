...
### scala.reflect.internal.FatalError: no context found for source-file://<WORKSPACE>/src/main/scala/MiniRV.scala,line-6,offset=217
...
// stall: 发生load-use冒险时启用. pc[输出接输入打一拍], if_id_reg, @@id_ex_reg
